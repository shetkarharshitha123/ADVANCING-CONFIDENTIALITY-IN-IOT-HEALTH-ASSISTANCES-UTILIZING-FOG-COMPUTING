        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <div class="post-preview">
                    <h2>Welcome To FogNode Home Page </h2>
                </div>
                <hr>
                <div class="post-preview">
                     ...
                     <p>Here the Fog Node will Take The Data From the Owners.</p>
                      <p>And Encrypt the Data Using AES Encryption System And Upload to Cloud.</p>
