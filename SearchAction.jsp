        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="SearchFile.jsp">Search File</a>
                    </li>
                    <li>
                        <a href="ViewDownloadFile.jsp">View Download File</a>
                    </li>
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                ...
                <div class="post-preview">
                    ...
                    <table>
                        <tr>
                            <th>File Id:</th> <th>File Name</th> <th>Download</th>
                        </tr>
                    <%
...
try{
  ...
  while(r.next()){
    ...
    if(filename.contains(fname)||fname.contains(filename)){
        %>
        <tr>
            <td><%=r.getString("id")%></td><td><%=r.getString("fname")%></td><td><a href="Download.jsp?fname=<%=r.getString("fname")%>">Download</a></td>
        </tr>
